                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{action('EventPrimaryController@store')}}">
                            ...
                            <div class="form-group">
                                <label class="col-md-4 control-label"> Годовой план</label>
                                <div class="col-md-6">
                                    <select class="form-control" name="id_PlanPrimaryLevel" value="{{ old('id_PlanPrimaryLevel') }}">
                                        @foreach($plan as $plans)
                                            <option value="{{$plans->id}}">{{$plans->year}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
